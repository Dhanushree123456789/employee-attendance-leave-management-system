...
2. Initialize the database using the provided script
3. Run the application and access it via browser

Note: Detailed setup steps are intentionally kept minimal as this project is intended for demonstration and evaluation purposes.
...
- CSS & JavaScript – Styling and client-side behavior
- Database scripts – Initialization and migration utilities
- Test scripts – Functional and validation testing
